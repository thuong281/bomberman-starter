...
public class Sprite {
    ...
    static {
        try {
            winner = new Image(new FileInputStream("res/sprites/winner.png"), 360, 180, false, false);
    ...
    public Image getFxImagePlayer() {
        ...
        Image input = new ImageView(wr).getImage();
        return resample(input, 1.75);
    }


    public Image resample(Image input, double scaleFactor) {
